...
public class FrmWithDrawalSuccess extends JFrame {
	 ...
	 */
	public FrmWithDrawalSuccess(String cardID) {
		super();
		initialize();
		this.cardID=cardID;
	}
		...
		if (mnExit == null) {
			...
			mnExit.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					FrmWithDrawalSuccess.this.dispose();
				}
			});
		}
		return mnExit;
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jlb1 = new JLabel();
			jlb1.setBounds(new Rectangle(31, 52, 297, 85));
			jlb1.setFont(new Font("Dialog", Font.BOLD, 24));
			jlb1.setText("WithDrawal Successful");
