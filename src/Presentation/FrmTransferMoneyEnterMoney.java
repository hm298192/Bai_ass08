...
public class FrmTransferMoneyEnterMoney extends JFrame {
	...
	private JTextField txtTransferMoney = null;
	 ...
	 */
	public FrmTransferMoneyEnterMoney(String senderAccountID,
			String receivedAccountID, String cardID) {
		super();
		initialize();
		...
		if (mnExit == null) {
			...
			mnExit.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					FrmTransferMoneyEnterMoney.this.dispose();
				}
			});
		}
		return mnExit;
		...
		if (btnEnter == null) {
			...
			btnEnter.addMouseListener(new java.awt.event.MouseAdapter() {
				public void mouseClicked(java.awt.event.MouseEvent e) {
					String str = txtTransferMoney.getText();

					double amountTransferMoney = Double.parseDouble(str);
					TransferHistoryBIZ transferHistoryBIZ = new TransferHistoryBIZ();

					try {
					
						// receivedAccountID, amountTransferMoney));
						boolean isTranfer = transferHistoryBIZ
								.transferMoney(senderAccountID,
										receivedAccountID, amountTransferMoney);

						if (!isTranfer) {
							setVisible(false);
						
							FrmTransferAmountMoneyNotValid frm = new FrmTransferAmountMoneyNotValid(
									transferHistoryBIZ.getMessage(), cardID);
							frm.setDefaultCloseOperation(EXIT_ON_CLOSE);
							frm.setVisible(true);

						} else {
							setVisible(false);
							FrmTransferSuccess frm = new FrmTransferSuccess(
									senderAccountID, receivedAccountID,
									amountTransferMoney, cardID);
	...
	private JButton getBtn2() {
		if (btn2 == null) {
			...
			btn2.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					txtTransferMoney.setText(addText(
							txtTransferMoney.getText(), "2"));
	 ...
	 */
	private JTextField getTxtTransferMoney() {
		if (txtTransferMoney == null) {
			txtTransferMoney = new JTextField();
			txtTransferMoney.setBounds(new Rectangle(75, 111, 195, 36));
		}
		...
		if (btnClear == null) {
			...
			btnClear.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					String str = txtTransferMoney.getText();
					if (str.length() > 0) {
						txtTransferMoney.setText(str.substring(0,
								str.length() - 1));
					}
				}
			});
