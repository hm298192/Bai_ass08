...
public class FrmTransferMoneyCheckAccount extends JFrame {
	...
	private JLabel lblReceivedAccount = null;
	private JLabel lblContinue = null;
	private JLabel lblCancel = null;
	private JLabel lblAsk = null;
	private JLabel lblAccountName=null;

	/**
	 * This is the default constructor
	 */
	public FrmTransferMoneyCheckAccount(String senderAccountID,
		...
		try {
			...
			lblReceivedAccount.setText("Received account: "+custID);
			lblAccountName.setText("Name: "+custName);
		...
		if (mnExit == null) {
			...
			mnExit.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					FrmTransferMoneyCheckAccount.this.dispose();
				}
			});
		}
		return mnExit;
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			lblReceivedAccount = new JLabel();
			lblReceivedAccount.setBounds(30, 20, 260, 25);
			lblReceivedAccount.setFont(new Font("Dialog", Font.BOLD, 15));
			lblReceivedAccount.setBackground(Color.lightGray);

			lblAccountName=new JLabel();
			lblAccountName.setBounds(30,50 , 260, 25);
			lblAccountName.setFont(new Font("Dialog", Font.BOLD, 15));
			lblAccountName.setBackground(Color.lightGray);

			
			lblAsk = new JLabel();
			lblAsk.setBounds(30, 50, 260, 100);
			...
			jPanel1.add(lblReceivedAccount, null);
		...
		if (btnSelect5 == null) {
			...
			btnSelect5.addMouseListener(new java.awt.event.MouseAdapter() {
				public void mouseClicked(java.awt.event.MouseEvent e) {
					...
					setVisible(false);
					FrmTransferMoneyEnterMoney frm = new FrmTransferMoneyEnterMoney(
		...
		if (btnSelect6 == null) {
			...
			btnSelect6.addMouseListener(new java.awt.event.MouseAdapter() {
				public void mouseClicked(java.awt.event.MouseEvent e) {
					...
					lblReceivedAccount.setText(UIMessage.GET_CARD);
					lblCancel.setText("");
					lblContinue.setText("");
					lblAsk.setText("");
				}
