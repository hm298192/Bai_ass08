...
public class FrmTransferSuccess extends JFrame {
	 ...
	 */
	public FrmTransferSuccess(String senderAccountID,
			String receivedAccountID,double amountStranferMoney,String cardID) {
		super();
		initialize();
		this.senderAccountID = senderAccountID;
		this.receivedAccountID = receivedAccountID;
		this.amountStranferMoney=amountStranferMoney;
		this.cardID=cardID;
		try {	
			//
			AccountBIZ accountBIZ = new AccountBIZ();
			String custID = accountBIZ.getCustIDOfAccount(
					accountBIZ.getListAccount(), receivedAccountID);
			CustomerBIZ custBIZ = new CustomerBIZ();
			String custName = custBIZ.getCustomerName(custID);
			//
			lblReceivedAcc.setText("Received Account: "+receivedAccountID);
			lblName.setText("Name: "+custName);
			lblAmount.setText("Amount transfer money: "+(new DecimalFormat("#")).format(amountStranferMoney));
			double balance= accountBIZ.getBalance(accountBIZ.getListAccount(), senderAccountID);
			lblYour.setText("Your balance: "+(new DecimalFormat("#")).format(balance));
	...
	double amountStranferMoney;
	String cardID;
	private JLabel lblTranfersuccess = null;
	private JLabel lblReceivedAcc = null;
	private JLabel lblName = null;
	private JLabel lblAmount = null;
	private JLabel lblYour = null;
	/**
	...
	private void initialize() {
		...
		this.setTitle("TransferMoneySuccess");
		...
		if (mnExit == null) {
			...
			mnExit.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					FrmTransferSuccess.this.dispose();
				}
			});
		}
		return mnExit;
	...
	private JButton getBtnPrint() {
		if (btnPrint == null) {
			...
			btnPrint.setLocation(new Point(561, 18));
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			lblYour = new JLabel();
			lblYour.setBounds(new Rectangle(19, 135, 282, 29));
			
			lblAmount = new JLabel();
			lblAmount.setBounds(new Rectangle(18, 109, 285, 27));
			
			lblName = new JLabel();
			lblName.setBounds(new Rectangle(19, 80, 284, 28));
		
			lblReceivedAcc = new JLabel();
			lblReceivedAcc.setBounds(new Rectangle(17, 55, 284, 24));
			
			lblTranfersuccess = new JLabel();
			lblTranfersuccess.setBounds(new Rectangle(82, 15, 268, 27));
			lblTranfersuccess.setFont(new Font("Dialog", Font.BOLD, 14));
			lblTranfersuccess.setText(UIMessage.SUCC_TRANSFER);
			
			lblAsk = new JLabel();
			lblAsk.setBounds(18, 181, 266, 34);
			...
			jPanel1.add(lblAsk);
			jPanel1.add(lblTranfersuccess, null);
			jPanel1.add(lblReceivedAcc, null);
			jPanel1.add(lblName, null);
			jPanel1.add(lblAmount, null);
			jPanel1.add(lblYour, null);
