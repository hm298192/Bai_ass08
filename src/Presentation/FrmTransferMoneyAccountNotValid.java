...
public class FrmTransferMoneyAccountNotValid extends JFrame {
	 ...
	 */
	public FrmTransferMoneyAccountNotValid(String cardID) {
		super();
		initialize();
	this.cardID=cardID;
	}
String cardID;
		...
		if (mnExit == null) {
			...
			mnExit.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					FrmTransferMoneyAccountNotValid.this.dispose();
				}
			});
		}
		return mnExit;
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			lblMessage.setText(UIMessage.ERR_REACCOUNT);
